...
def main(request):
    return render(
        request, "app_instagram/index.html", context={"title": "Killer Instagram"}
    )
...
def upload(request):
    ...
    return render(
        ...
        context={"title": "Killer Instagram", "form": form},
    )
...
def pictures(request):
    ...
    return render(
        ...
        context={"title": "Killer Instagram", "pictures": pictures},
    )


@login_required
def remove_picture(request, pic_id):
    pic = Picture.objects.filter(id=pic_id, user=request.user)
    try:
